angular.module("app.proxy", []).factory("RestClient", ["$http", "config", "$localStorage", "$filter", "$rootScope",
    function($http, config, $localStorage, $filter, $rootScope) {
        ...
        return {
            given_key_cached_data: function(id, callBack) {
                getRequest("/cached_data/given_id/" + id, callBack);
            },
            all: function(callBack) {
                getRequest("/cached_data/all/", callBack);
            },
            update_create: function(obj, callBack) {
                postRequest("/cached_data/update_create/", obj, callBack);
            },
            delete_id: function(id, callBack) {
                getRequest("/cached_data/delete_id/" + id, callBack);
            },
            delete_all: function(callBack) {
                getRequest("/cached_data/delete_all/", callBack);

            },
            check_TTL: function(callBack) {
                getRequest("/cached_data/check_ttl/", callBack);
            },
            check_cache_length: function(cached_item, callBack) {
                postRequest("/cached_data/check_cache_length/", cached_item, callBack);
            },
